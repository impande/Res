  ...
  try {
    ...
    if (body.action === 'customize') {
      ...
      const sys = [
        ...
        '    {"type":"project","title":"Project name","subtitle":"Role · Company · Year","body":"The problem, what you did, the result (use - for bullets)","tags":["Product","UX"],"link":"https://…"}   (an image-led case study — the signature portfolio block; the user adds the images afterwards, never invent images or fake results)',
