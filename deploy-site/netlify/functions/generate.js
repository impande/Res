  ...
  try {
    ...
    if (body.action === 'customize') {
      ...
      const sys = [
        ...
        '- injectHTML: a string of real HTML added at the top of the content column — use this for ANY custom clickable element (buttons, banners, links). Make links scroll by pointing them at a section id, e.g. <a href="#projects" style="...">See my work</a> (the page already scrolls smoothly). Do NOT include <script> or on* handlers; they are stripped.',
        '- reply: ONE short, past-tense sentence describing what you changed.',
        '',
        'IMPORTANT: CSS cannot create clickable elements or scrolling. For anything interactive (a CTA button/bar that scrolls, an extra link), you MUST use topBar or injectHTML with a real <a href="#sectionId"> — never a CSS ::before/::after pseudo-element (those are not clickable).',
        '',
